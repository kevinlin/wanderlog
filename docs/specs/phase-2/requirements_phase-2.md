...
- 2026-07-26: Req 4.10 (editing controls disabled offline) amended by [requirements_phase-4.md](../phase-4/requirements_phase-4.md): the Phase 4 visit-details form is exempt and remains savable offline. Every other editor stays offline-disabled.
