...
- 2026-07-26: Amended by [requirements_phase-4.md](../phase-4/requirements_phase-4.md). Req 4.10 (editing controls disabled offline): the Phase 4 visit-details form is exempt and remains savable offline; every other editor stays offline-disabled. Req 4.5 (trip metadata editing): the trip's timezone becomes editable, without which a TripIt-imported trip stamps every visit in the importing device's zone.
