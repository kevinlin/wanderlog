...
import { isValidTimeZone, isValidTripLocal } from '../services/visitRecord.js';
...
// The visit record. Both fields are optional, so a file written before Phase 4
// imports exactly as it did before. `duration` is separate and unchanged: it
// holds the planned estimate, mostly ranges and prose.
const visitFields = {
